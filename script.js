    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "HDI פרסומות בAI משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a81a3bb-0e9c-459d-9be4-cb0af1d36f0c',
                    name: data.name || '',
                    email: data.email || '',
